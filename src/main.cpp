...
static void drawMenuBackdrop(){
    ...
    DrawCircleGradient(Vector2{(float)w - 170.0f, 95.0f}, 260.0f, Fade(SKYBLUE,.28f), Fade(BLANK,0));
    DrawCircleGradient(Vector2{130.0f, (float)h - 90.0f}, 230.0f, Fade(PURPLE,.22f), Fade(BLANK,0));
    for(int i=0;i<70;i++){
    ...
    DrawText("v17 clean GUI - Made by y8tireu",w-300,17,18,Fade(GOLD,.9f));
}
...
static void drawLoading(float p){
    ...
    DrawCircleGradient(Vector2{1000.0f, 180.0f}, 90.0f, Fade(GOLD,.22f+pulse*.10f), Fade(BLANK,0));
